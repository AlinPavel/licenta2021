  ...
  describe('Catalog routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return ICatalog returned by find', () => {
        // GIVEN
        service.find = jest.fn(idCatalog => of(new HttpResponse({ body: { idCatalog } })));
        mockActivatedRouteSnapshot.params = { idCatalog: 123 };
        ...
        expect(resultCatalog).toEqual({ idCatalog: 123 });
      });
